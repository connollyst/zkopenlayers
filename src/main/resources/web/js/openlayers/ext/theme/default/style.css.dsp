...
.olControlNavigationHistory {
   background-image: url(${c:encodeThemeURL('~./js/openlayers/ext/theme/default/img/navigation_history.png')});
   background-repeat: no-repeat;
   width:  24px;
   height: 24px;
...
.olControlEditingToolbar div {
    background-image: url(${c:encodeThemeURL('~./js/openlayers/ext/theme/default/img/editing_tool_bar.png')});
    background-repeat: no-repeat;
    margin: 0 0 5px 5px;
    width: 24px;
    height: 22px;
